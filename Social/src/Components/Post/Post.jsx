...
export default function Post({post}) {
  ...
  useEffect(()=>{
    const fetch = async()=>{
      ...
      const usr = await axios.get(`http://localhost:8800/api/users?userId=${post.userId}`);
      ...
      <div className="postwrapper">
        ...
        <div className="postbottom">
            <div className="postbottomleft">
                <img className="like" onClick={likehandler} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLudBUAQNGPerdvGD3gHqObUr1mYm7lk383w&usqp=CAU" alt="" />
                
                <span className="postbottomCounter">{like} people liked it</span>
            </div>
