...
router.delete("/:id",async(req,res)=>{
    ...
    try {
        ...
        return res.status(403).json("You can delete only yor account");
    }
})
// get a user
    ...
    if(req.body.userId!==req.params.id){
        try {
            ...
            if(!user.followers.includes(req.body.userId)){
                ...
                await curr.updateOne({$push:{followings:req.params.id}});
    ...
    if(req.body.userId!==req.params.id){
        try {
            ...
            if(user.followers.includes(req.body.userId)){
                ...
                await curr.updateOne({$pull:{followings:req.body.userId}});
